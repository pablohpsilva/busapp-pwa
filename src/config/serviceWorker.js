import serviceWorkerCachePolyfill from './serviceWorkerCachePolyfill';

serviceWorkerCachePolyfill();

const CACHE_NAME = 'busapp-pwa-v2';
/* eslint-disable */
